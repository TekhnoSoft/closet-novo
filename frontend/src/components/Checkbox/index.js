...
export default ({children, checked, setChecked, flexStart, noMargin}) => {
    ...
    return (
        <div className={noMargin ? `` :`mt-2 mb-2`} style={{display: 'flex', alignItems: 'center', justifyContent: flexStart ? 'flex-start' : 'space-between', cursor: 'pointer', userSelect: 'none'}} onClick={handleChangeChecked}>
